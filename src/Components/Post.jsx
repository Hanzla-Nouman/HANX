    ...
    <>
      <div className="card m-3 " style={{ width: "40rem" }}>
        <div className="card-body">
          <span className="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger crossCont" onClick={()=>deletePost(post.id)}>
          ...
          <div className="alert alert-secondary my-2" role="alert">
            This post has been reaacted by {post.reactions} people
          </div>
        </div>
      </div>
    </>
